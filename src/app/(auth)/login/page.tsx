...
export default function LoginPage() {
  ...
  async function handleGoogle() {
    ...
    // After Google OAuth, middleware handles onboarding redirect if needed
      ...
      >
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white text-center p-12">
          <h2 className="text-3xl font-bold mb-4">
            Espacios únicos para momentos únicos
          </h2>
          <p className="text-white/80 max-w-sm">
            Más de 2.500 espacios verificados en toda España esperando tu próxima reserva.
          </p>
        </div>
      </div>
    </div>
